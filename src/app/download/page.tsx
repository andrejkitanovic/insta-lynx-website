...
import { mobileAppJsonLd } from "@/lib/seo";
    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-white/8">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-20 sm:pt-28 lg:grid-cols-2 lg:items-center">
          ...
          {/* App screenshots, three iPhone frames, fanned */}
          <Reveal delay={0.1}>
            <div className="relative flex h-[480px] items-center justify-center sm:h-[560px]">
              {/* glow */}
              <div className="pointer-events-none absolute inset-0 -z-10">
                <div className="absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-linear-to-b from-white/6 via-white/2 to-transparent blur-3xl" />
              </div>

              {[
                { src: "/screenshots/1.webp", alt: "NovaLinx welcome screen", rotate: -10, x: -110, z: 1 },
                { src: "/screenshots/3.webp", alt: "Browse CDL trucking jobs in the NovaLinx app", rotate: 0, x: 0, z: 3 },
                { src: "/screenshots/2.webp", alt: "Track your trucking job applications", rotate: 10, x: 110, z: 2 },
              ].map((s, i) => (
                <motion.div
                  key={s.src}
                  ...
                  style={{ x: s.x, zIndex: s.z }}
                  className="absolute"
                >
                  <div className="relative h-[420px] w-[200px] overflow-hidden rounded-[2.25rem] border-[6px] border-neutral-900 bg-neutral-900 shadow-[0_25px_60px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.08)] sm:h-[480px] sm:w-[228px]">
                    <Image
                      src={s.src}
                      alt={s.alt}
                      fill
